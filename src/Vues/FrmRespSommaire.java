 ...
 * @author louis
 */
public class FrmRespSommaire extends javax.swing.JFrame {
    static User leUser;
    /**
     * Creates new form FrmRespSommaire
     */
    public FrmRespSommaire(User unUser) {
        initComponents();
        leUser = unUser;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRespSommaire.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRespSommaire(leUser).setVisible(true);
            }
        });
    }
